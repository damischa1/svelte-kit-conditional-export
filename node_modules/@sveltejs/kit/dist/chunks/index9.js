...
import { g as globrex_1 } from './index6.js';
import { r as rimraf, m as mkdirp } from './index3.js';
...
function create_filter(options) {
	const include = options.include.map((str) => str && globrex_1(str));
	const exclude = options.exclude.map((str) => str && globrex_1(str));
